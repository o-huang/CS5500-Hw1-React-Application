...
const TUITS_API = "https://cs5500-assignment4.herokuapp.com/api/tuits";
const USERS_API = "https://cs5500-assignment4.herokuapp.com/api/users";
...
export const deleteTuitsByTuit = (tuit) =>
    axios.get(`${TUITS_API}/tuit/${tuit}/delete`)
        .then(response => response.data);
